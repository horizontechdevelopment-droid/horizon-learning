...
An ISO file is a disk image. Think of it like a packaged copy of an operating system that can be written to a USB drive.
...
More advanced users can verify the downloaded file using checksums or signatures.

Verification helps confirm that the downloaded file matches what Kali published.

For the first version of this beginner guide, the safest simple rule is:

- Download only from the official Kali website
- Do not use third-party download sites
- Do not use files sent by strangers
- Re-download if something looks wrong

A future version of this guide may include a full beginner-friendly verification walkthrough.
...
- [ ] You understand the ISO will be written to a USB drive in the next lesson.
